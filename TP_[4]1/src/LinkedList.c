...
static Node* getNode(LinkedList* this, int nodeIndex)
{
	...
	Node* nodoActual = NULL;   //Crea un nodo null
	...
	if (this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
		{
			...
			if (auxNodo != NULL)
			{
				...
				else
				{
					...
					auxNodo->pNextNode = auxNodoAnterior->pNextNode;// el nuevo nodo apunta a donde apuntaba el nodo anterior
					auxNodoAnterior->pNextNode = auxNodo;// el anterior nodo que apuntaba a null ahora apunta al nodo nuevo
